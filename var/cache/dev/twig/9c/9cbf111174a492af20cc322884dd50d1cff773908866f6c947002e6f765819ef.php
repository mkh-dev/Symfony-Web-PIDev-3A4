...
class __TwigTemplate_283c38bc0400d28cff57c9323ffbc31c7ef8be0495c438364517448820859dd8 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("back/back.html.twig", "produit/index.html.twig", 1);
...
.btn {
  ...
  box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3);
    ...
    <a href=\"{{ path('app_produit_new')}}\" style=\"float: right;\"><img src=\"{{ asset('back/img/plus.png') }}\" alt=\"Créer un nouveau produit\" style=\"width:40px; height:40px;\"></a>
...
<td>
  {% if produit.image %}
    <img src=\"{{ asset('uploads/produits/' ~ produit.image) }}\" alt=\"{{ produit.nomProd }}\">
  {% endif %}
</td>
                ...
                <td>
                  ...
                  <a href=\"{{ path('app_produit_show', {'idProd': produit.idProd})}}\" \"><img src=\"{{ asset('back/img/chercher.png') }}\" alt=\"Afficher le produit\" style=\"width:20px; height:20px;\"></a>


                  
                   {{ include('produit/_delete_form.html.twig') }}
                  <a href=\"{{ path('app_produit_edit', {'idProd': produit.idProd}) }}\" \"><img src=\"{{ asset('back/img/crayon.png') }}\" alt=\"Modifier le produit\" style=\"width:20px; height:20px;\"></a>
...
<!--End of Tawk.to Script-->
{% endblock %}
", "produit/index.html.twig", "C:\\Users\\ouesl\\Desktop\\3A\\Symfony-Web-PIDev-3A4\\templates\\produit\\index.html.twig");
    }
}
