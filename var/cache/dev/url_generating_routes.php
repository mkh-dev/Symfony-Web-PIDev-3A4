...
return [
    ...
    'abonnemnt_mobile' => [[], ['_controller' => 'App\\Controller\\AbonnementMobileController::abonnementmobile'], [], [['text', '/abonnement_mobile']], [], [], []],
    'newabonnement_mobile' => [['idUser', 'prix', 'type', 'renouvellement', 'dateExpire', 'plafond', 'currency'], ['_controller' => 'App\\Controller\\AbonnementMobileController::newabonnement'], [], [['variable', '/', '[^/]++', 'currency', true], ['variable', '/', '[^/]++', 'plafond', true], ['variable', '/', '[^/]++', 'dateExpire', true], ['variable', '/', '[^/]++', 'renouvellement', true], ['variable', '/', '[^/]++', 'type', true], ['variable', '/', '[^/]++', 'prix', true], ['variable', '/', '[^/]++', 'idUser', true], ['text', '/newabonnement_mobile']], [], [], []],
    'SupprimerAbonnement' => [[], ['_controller' => 'App\\Controller\\AbonnementMobileController::SupprimerAbonnement'], [], [['text', '/SupprimerAbonnement']], [], [], []],
    'updateAbonnement' => [[], ['_controller' => 'App\\Controller\\AbonnementMobileController::updateAbonnement'], [], [['text', '/updateAbonnement']], [], [], []],
    ...
    'app_reservations_json' => [[], ['_controller' => 'App\\Controller\\ReservationControllerMobile::index'], [], [['text', '/reservations/json']], [], [], []],
    'list' => [[], ['_controller' => 'App\\Controller\\ReservationControllerMobile::getRes'], [], [['text', '/listReservationsJson']], [], [], []],
    'reservation' => [['numRes'], ['_controller' => 'App\\Controller\\ReservationControllerMobile::ReservationId'], [], [['variable', '/', '[^/]++', 'numRes', true], ['text', '/ReservationJson']], [], [], []],
    'editfr' => [[], ['_controller' => 'App\\Controller\\ReservationControllerMobile::Modifier'], [], [['text', '/ReservationJson/edit']], [], [], []],
    'updateStudentJSON' => [[], ['_controller' => 'App\\Controller\\ReservationControllerMobile::updateStudentJSON'], [], [['text', '/addReservationJSON']], [], [], []],
    'updateReservationJSON' => [['numRes'], ['_controller' => 'App\\Controller\\ReservationControllerMobile::updateReservationJSON'], [], [['variable', '/', '[^/]++', 'numRes', true], ['text', '/updateReservationJSON']], [], [], []],
    'deleteReservationJSON' => [['numRes'], ['_controller' => 'App\\Controller\\ReservationControllerMobile::deleteStudentJSON'], [], [['variable', '/', '[^/]++', 'numRes', true], ['text', '/deleteReservationJSON']], [], [], []],
