...
return [
    ...
    'reclamations_mobile' => [[], ['_controller' => 'App\\Controller\\ReclamationsMobileController::reclamationsmobile'], [], [['text', '/reclamations_mobile']], [], [], []],
    'newreclamations_mobile' => [['prenom', 'nom', 'email', 'message'], ['_controller' => 'App\\Controller\\ReclamationsMobileController::newreclamations'], [], [['variable', '/', '[^/]++', 'message', true], ['variable', '/', '[^/]++', 'email', true], ['variable', '/', '[^/]++', 'nom', true], ['variable', '/', '[^/]++', 'prenom', true], ['text', '/newreclamations_mobile']], [], [], []],
    'SupprimerReclamations' => [[], ['_controller' => 'App\\Controller\\ReclamationsMobileController::SupprimerReclamations'], [], [['text', '/SupprimerReclamations']], [], [], []],
    'updateReclamations' => [[], ['_controller' => 'App\\Controller\\ReclamationsMobileController::updateReclamations'], [], [['text', '/updateReclamations']], [], [], []],
