...
return [
    ...
    'reservation_by_numRes' => [['numRes'], ['_controller' => 'App\\Controller\\ReservationControllerMobile::getReservationByNumRes'], [], [['variable', '/', '[^/]++', 'numRes', true], ['text', '/ReservationJson']], [], [], []],
    'userS_offresbyid_json' => [['numres'], ['_controller' => 'App\\Controller\\ReservationControllerMobile::offresClient'], [], [['variable', '/', '[^/]++', 'numres', true], ['text', '/ResJ']], [], [], []],
