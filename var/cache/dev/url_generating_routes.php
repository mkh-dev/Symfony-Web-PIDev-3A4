...
return [
    ...
    'app_json' => [[], ['_controller' => 'App\\Controller\\SerializerController::allColis'], [], [['text', '/allUsers']], [], [], []],
    'app_users_json' => [['id'], ['_controller' => 'App\\Controller\\SerializerController::ColisID'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/allColis']], [], [], []],
    'app_json_new' => [[], ['_controller' => 'App\\Controller\\SerializerController::Add'], [], [['text', '/new']], [], [], []],
    'app_json_edit' => [['id'], ['_controller' => 'App\\Controller\\SerializerController::updateJson'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true]], [], [], []],
    'app_json_delete' => [['id'], ['_controller' => 'App\\Controller\\SerializerController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/delete']], [], [], []],
