...
<<<<<<<< Updated upstream:var/cache/dev/ContainerYyV6xRA/getProdLikeRepositoryService.php
namespace ContainerYyV6xRA;

========
namespace Container6P8OaWR;
>>>>>>>> Stashed changes:var/cache/dev/Container6P8OaWR/getProdLikeRepositoryService.php
 ...
 */
class getProdLikeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProdLikeRepository' shared autowired service.
     *
     * @return \App\Repository\ProdLikeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProdLikeRepository.php';

        return $container->privates['App\\Repository\\ProdLikeRepository'] = new \App\Repository\ProdLikeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
