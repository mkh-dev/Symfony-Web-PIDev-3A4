 ...
 */
class getReservationJsonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationJsonRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationJsonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationJsonRepository.php';

        return $container->privates['App\\Repository\\ReservationJsonRepository'] = new \App\Repository\ReservationJsonRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
