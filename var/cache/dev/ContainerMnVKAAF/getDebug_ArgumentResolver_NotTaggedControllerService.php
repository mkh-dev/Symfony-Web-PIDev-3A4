...
<<<<<<<< Updated upstream:var/cache/dev/Container00UJSnM/getDebug_ArgumentResolver_NotTaggedControllerService.php
namespace Container00UJSnM;
========
namespace ContainerMnVKAAF;
>>>>>>>> Stashed changes:var/cache/dev/ContainerMnVKAAF/getDebug_ArgumentResolver_NotTaggedControllerService.php
...
class getDebug_ArgumentResolver_NotTaggedControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.LygHwDe'] ?? $container->load('get_ServiceLocator_LygHwDeService'));
