...
<<<<<<<< Updated upstream:var/cache/dev/ContainerYyV6xRA/getSecurity_AccessMapService.php
namespace ContainerYyV6xRA;

========
namespace ContainerMnVKAAF;
>>>>>>>> Stashed changes:var/cache/dev/ContainerMnVKAAF/getSecurity_AccessMapService.php
...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/reclamations'), [0 => 'ROLE_ADMINISTRATEUR'], NULL);
