...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/reclamations'), [0 => 'ROLE_PARTENAIRE', 1 => 'ROLE_ORGANISATEUR', 2 => 'ROLE_TRANSPORTEUR', 3 => 'ROLE_ADMIN', 4 => 'ROLE_UTILISATEUR'], NULL);
