...
<<<<<<<< HEAD:var/cache/dev/ContainerQv7k3lb/getDebug_ArgumentResolver_ServiceService.php
namespace ContainerQv7k3lb;

========
namespace Container3eXcBqx;
>>>>>>>> MalekBranch:var/cache/dev/Container3eXcBqx/getDebug_ArgumentResolver_ServiceService.php
...
class getDebug_ArgumentResolver_ServiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.XwRqSJU'] ?? $container->load('get_ServiceLocator_XwRqSJUService'));
