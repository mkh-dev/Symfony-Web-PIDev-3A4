 ...
 */
final class Version20230422093556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE id_cat_prod id_cat_prod INT DEFAULT NULL, CHANGE description description LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE id_cat_prod id_cat_prod INT NOT NULL, CHANGE description description VARCHAR(255) NOT NULL');
